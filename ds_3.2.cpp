...
/*
*  3.2
*  Գրել ծրագիր, որը ներածում է մինչև 1000 հատ ամբողջ թիվ, դրանցից կառուցում է միակապ ցուցակ, 
*  ապա ցուցակում յուրաքանչյուր տարրից թողնում է մեկական նմուշ,
*  վերջում արտածում է ցուցակի պարունակությունը։
*/
